  ...
  return (
    <section id="demo" className="cta-section" ref={ref} style={{ padding: '80px 2.5rem 140px', maxWidth: 1320, margin: '0 auto' }}>
      <div className="cta-card" style={{
        ...
        <span className="corner-mark" style={{ position: 'absolute', top: 24, left: 24, fontFamily: 'JetBrains Mono, monospace', fontSize: 10, color: 'var(--azul-claro)', letterSpacing: '0.2em' }}>§ 09 · CONTACTO</span>
