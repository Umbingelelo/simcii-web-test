...
function ridgeProfile(width, segments, peaks, baseY, amp, phase) {
  ...
  for (let i = 0; i <= segments; i++) {
    ...
    const jag = Math.sin(t * peaks * Math.PI + phase) * amp + Math.sin(t * peaks * 2.3 * Math.PI + phase * 1.7) * amp * 0.35 + Math.sin(t * peaks * 5.1 * Math.PI + phase * 0.5) * amp * 0.14;
    pts.push([x, baseY + Math.abs(jag)]);
  }
  return pts;
}
function buildRidgeMesh(THREE, {
  width,
  color,
  baseY,
  amp,
...
function SvgCordilleraFallback({
  style
}) {
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    d: "M0 150 L70 95 L120 130 L180 70 L240 120 L300 60 L360 110 L420 80 L460 120 L460 200 L0 200 Z",
    fill: "var(--gris-ciudad)",
    opacity: "0.32"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M0 170 L80 120 L140 150 L210 100 L270 140 L340 95 L400 135 L460 110 L460 200 L0 200 Z",
    fill: "var(--azul-deep)",
    opacity: "0.9"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M0 200 L90 150 L160 178 L230 140 L300 175 L370 145 L440 180 L460 165 L460 200 Z",
    fill: "var(--terracota)"
  }));
}
function Cordillera3D({
  height = 540,
  style
}) {
  ...
  React.useEffect(() => {
    ...
    const fondo = buildRidgeMesh(THREE, {
      width: 64,
      color: CORD_COLORS.fondo,
      baseY: 6,
      amp: 9,
      peaks: 4,
      depth: 2,
    ...
    const medio = buildRidgeMesh(THREE, {
      width: 62,
      color: CORD_COLORS.medio,
      baseY: 3,
      amp: 7.5,
      peaks: 5,
      depth: 3,
    ...
    const frontal = buildRidgeMesh(THREE, {
      width: 60,
      color: CORD_COLORS.frontal,
      baseY: 0,
      amp: 6,
      peaks: 6,
      depth: 4,
  ...
  if (fallback) {
    ...
    }, /*#__PURE__*/React.createElement(SvgCordilleraFallback, null));
  }
  return /*#__PURE__*/React.createElement("div", {
    ref: mountRef,
    style: {
